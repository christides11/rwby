...
namespace rwby
{
    ...
    /// </summary>
    public partial class FGroundKCCProcessor : KCCProcessor, IGroundKCCProcessor
    {
        // CONSTANTS
        ...
        public float JumpMultiplier => 1;//_jumpMultiplier;

        // PRIVATE MEMBERS

        [SerializeField]
        [Tooltip("Maximum allowed speed the KCC can move with player input.")]
        private float _kinematicSpeed = 1000.0f;
        //[SerializeField]
        //[Range(0.0f, 1.0f)]
        ...
        public override void SetKinematicVelocity(KCC kcc, KCCData data)
        {
            ...
            //Vector3 acceleration = KCCPhysicsUtility.GetAcceleration(kinematicVelocity, data.KinematicTangent, Vector3.one, data.KinematicSpeed, false,
            //    data.KinematicDirection.magnitude, _constantKinematicAcceleration, _relativeKinematicAcceleration, _proportionalKinematicAcceleration, data.DeltaTime, kcc.FixedData.DeltaTime);
            
            //Vector3 friction = KCCPhysicsUtility.GetFriction(kinematicVelocity, moveDirection, Vector3.one, data.GroundNormal, data.KinematicSpeed, false,
            //    _constantKinematicFriction, _relativeKinematicFriction, _proportionalKinematicFriction, data.DeltaTime, kcc.FixedData.DeltaTime);

...
namespace rwby
{
    [CreateAssetMenu(fileName = "AddressablesHUDElementbank", menuName = "rwby/Content/Addressables/HUDElementbankDefinition")]
    public class AddressablesHUDElementbankDefinition : IHUDElementbankDefinition
    {

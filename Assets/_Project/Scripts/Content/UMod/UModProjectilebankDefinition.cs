...
namespace rwby
{
    [CreateAssetMenu(fileName = "ProjectilebankDefinition", menuName = "rwby/Content/UMod/Projectilebank")]
    public class UModProjectilebankDefinition : IProjectilebankDefinition
    {

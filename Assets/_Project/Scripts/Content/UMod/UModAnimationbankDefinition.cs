...
namespace rwby
{
    [CreateAssetMenu(fileName = "AnimationbankDefinition", menuName = "rwby/Content/UMod/AnimationbankDefinition")]
    public class UModAnimationbankDefinition : IAnimationbankDefinition
    {

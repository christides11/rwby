...
namespace Cinemachine
{
    ...
    public static class FusionRuntimeUtility
    {
        ...
        public static bool RaycastIgnoreTag(
            NetworkRunner runner, Ray ray, out RaycastHit hitInfo, float rayLength, int layerMask, in string ignoreTag)
        {
            ...
            {
                int closestHit = -1;
                int numHits = runner.GetPhysicsScene().Raycast(
        ...
        public static bool SphereCastIgnoreTag(
            NetworkRunner runner, Vector3 rayStart, float radius, Vector3 dir, 
            ...
            int layerMask, in string ignoreTag)
        {
            ...
            int numHits = runner.GetPhysicsScene().SphereCast(

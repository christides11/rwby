...
namespace rwby
{
    ...
    public class ApplyJumpForceBehaviour : GravityBehaviour
    {
        ...
        public FighterStatReferenceFloatBase maxJumpTime = new FighterStatReferenceFloatBase();
        ...
        [HideIf("useValue"), AllowNesting]
        [SelectImplementation((typeof(FighterStatReferenceBase<float>)))] [SerializeReference]
        public FighterStatReferenceFloatBase fallGravityMultiplier = new FighterBaseStatReferenceFloat();

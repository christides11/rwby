...
namespace rwby
{
    [StateVariable("Projectile/Set Rotation")]
    public struct VarProjectileSetRotation : IStateVariables
    {
        public string name;
        public string Name
        {
        ...
        public VarInputSourceType rotationSource;
        public Vector3 rotation;

        public IStateVariables Copy()
        {
            return new VarProjectileSetRotation()
            {

...
namespace rwby
{
    [StateVariable("Set Grounded State")]
    public struct VarSetGroundedState : IStateVariables
    {
        public string name;
        public string Name
        {
        ...
        public StateGroundedGroupType groundedGroup;

        public IStateVariables Copy()
        {
            return new VarSetGroundedState()
            {
                groundedGroup = groundedGroup,
            };
        }
    }
}
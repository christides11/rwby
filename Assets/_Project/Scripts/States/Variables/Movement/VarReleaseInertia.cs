...
namespace rwby
{
    [StateVariable("Movement/Release Inertia")]
    public struct VarReleaseInertia : IStateVariables
    {
        public string name;
        public string Name
        {
        ...
        public bool applyToMovement;

        public IStateVariables Copy()
        {
            return new VarReleaseInertia()
            {
                applyToMovement = applyToMovement,
            };
        }
    }
}
...
namespace Malee.List {
	...
	public class ReorderableList {
		...
		public delegate void ReorderActionDelegate(ReorderableList list, int oldElement, int newElement);
		...
		public event ReorderActionDelegate onReorderCustomCallback;
		...
		*/
		...
		private void ReorderDraggedElements(int direction, int offset, System.Action sortList) {
			...
			while (--s > -1) {
				...
				onReorderCustomCallback?.Invoke(this, dragList[newIndex].startIndex, listIndex);
			}

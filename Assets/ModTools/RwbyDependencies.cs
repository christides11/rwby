...
namespace rwby
{
    public static class RwbyDependencies
    {
        public static readonly Tuple<string, string>[] packages =
        {
            ...
            new Tuple<string, string>("com.yasirkula.ingamedebugconsole@1.5.8", "https://github.com/yasirkula/UnityIngameDebugConsole.git#1.5.8"),
            new Tuple<string, string>("com.inc8877.graphicsconfigurator@1.1.1", "https://github.com/yasirkula/UnityIngameDebugConsole.git#1.1.1")
        };

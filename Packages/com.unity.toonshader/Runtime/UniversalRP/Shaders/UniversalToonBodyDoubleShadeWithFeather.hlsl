...
//v.2.0.7
                ...
                //float4 _LineTex_var = lerp(SAMPLE_TEXTURE2D(_LineTex, sampler_MainTex, TRANSFORM_TEX(Set_UV0, _LineTex)), _MainTex_var, 1 - _Use_LineMap);
                //finalColor = finalColor * (1 - _LineTex_var.a) + (_LineTex_var * _LineTex_var.a);

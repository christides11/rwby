...
//v.2.0.4
                ...
                if(_Use_LineMap == 1)
                {
                    float4 _LineTex_var = SAMPLE_TEXTURE2D(_LineTex, sampler_MainTex, TRANSFORM_TEX(Set_UV0, _LineTex));//lerp(SAMPLE_TEXTURE2D(_LineTex, sampler_MainTex, TRANSFORM_TEX(Set_UV0, _LineTex)), finalRGBA, 1 - _Use_LineMap);
